...
import * as __fd_glob_0 from "../content/generating-sounds-with-ai/index.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content", {}, {"generating-sounds-with-ai/index.mdx": __fd_glob_0, "12-principles-of-animation/index.mdx": __fd_glob_1, "mastering-animate-presence/index.mdx": __fd_glob_2, "morphing-icons/index.mdx": __fd_glob_3, "sounds-on-the-web/index.mdx": __fd_glob_4, "taking-advantage-of-pseudo-elements/index.mdx": __fd_glob_5, "to-spring-or-not-to-spring/index.mdx": __fd_glob_6, });